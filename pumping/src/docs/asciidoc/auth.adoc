...
include::{snippets}/oauth2-apple-get-login-url/http-request.adoc[]

=== Response

include::{snippets}/oaut/http-response.adoc[]
include::{snippets}/oauth2-apple-get-login-url/response-fields.adoc[]
